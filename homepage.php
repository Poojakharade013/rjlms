...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top" style="background-image: linear-gradient(gray,#2144);">
      ...
      <a class="navbar-brand mr-1" href="index.php" style="text-shadow: 0px 1px 5px black;">RJ COLLEGE'S LMS</a>
        ...
        <div class="container-fluid">
          ...
          <!-- Breadcrumbs-->
           ...
           <div class="Student_logo">
            <a href="#" class="image full"><img src="https://mltnu5r4mmy0.i.optimole.com/cb:HrXz.42586/w:auto/h:auto/q:mauto/f:avif/id:5c2e4118bbb252b1f9eb4ebf8769952b/https://rebuiltech.com/jhunjhunwala-college-01.jpg" style="width:1260px;" style="background-attachment: fixed;" style="background-size: contain;"  > </a>
          <!-- Page Content -->
          <h4></h4>
          <hr> 
          <p> <h5>  </h5></p>
